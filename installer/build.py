...
def build():
    ...
    cmd.extend([
        ...
        "--hidden-import", "plugins.sdk",
        "--hidden-import", "plugins.sdk.api",
        "--hidden-import", "plugins.sdk.manager",
        "--hidden-import", "plugins.sdk.events",
        "--hidden-import", "plugins.sdk.loader",
        "--hidden-import", "plugins.sdk.permissions",
        "--hidden-import", "plugins.sdk.registry",
        "--hidden-import", "plugins.sdk.sandbox",
        "--hidden-import", "plugins.sdk.state",
        "--hidden-import", "ddgs",
